...
export default function Concept2() {
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-[#121212] antialiased selection:bg-[#C5A059] selection:text-white">
      <style>{`
      ...
      <nav className="fixed w-full z-50 top-0 px-6 py-8 md:px-12 flex justify-between items-center bg-[#FAFAFA]/95 backdrop-blur-sm border-b border-gray-100/50">
        <div className="text-xs md:text-sm tracking-[0.2em] font-sans-c font-bold uppercase text-[#8c8c8c]">
          Миралигал
        </div>
      ...
      <main className="pt-32 pb-12 px-6 md:px-12 max-w-screen-2xl mx-auto min-h-screen flex flex-col justify-between">
        <div className="flex flex-col gap-12 lg:gap-24 mt-8">
            ...
            <div className="lg:col-span-8 animate-load delay-200">
              <h1 className="font-serif-c text-5xl md:text-7xl lg:text-8xl leading-[0.95] text-[#121212] font-normal tracking-tight">
                ...
                <span className="text-[#8c8c8c] italic relative">
                  адвоката г. Москвы
                  <span className="hidden md:block absolute top-1/2 -right-32 w-24 h-[1px] bg-[#C5A059]/50"></span>
                </span><br />
                Марии Мирошниковой
              </h1>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-6 animate-load delay-300 pl-0 lg:pl-12">
              <p className="font-sans-c text-lg md:text-xl leading-relaxed text-[#121212]/80 font-light border-l border-[#C5A059] pl-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-24 pt-8 border-t border-gray-200/60 animate-load delay-500">
          <div className="col-span-2 md:col-span-1 flex items-end">
            <span className="font-serif-c italic text-2xl text-[#C5A059]">Миралигал</span>
          </div>
          <div>
            <span className="block font-serif-c text-3xl md:text-4xl text-[#121212] mb-1">25+</span>
            <span className="block font-sans-c text-xs font-bold tracking-widest uppercase text-[#8c8c8c]">Лет опыта</span>
          </div>
          <div>
            <span className="block font-serif-c text-3xl md:text-4xl text-[#121212] mb-1">80+</span>
            <span className="block font-sans-c text-xs font-bold tracking-widest uppercase text-[#8c8c8c]">Проектов</span>
          </div>
          <div>
            <span className="block font-serif-c text-3xl md:text-4xl text-[#121212] mb-1">$100M+</span>
      ...
      <section id="practice" className="px-6 md:px-12 py-24 bg-white border-t border-gray-100">
        <div className="max-w-screen-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-16">
            {services.map((s) => (
              <div key={s.num} className="group border-b border-gray-100 pb-8 hover:border-[#C5A059] transition-colors duration-500">
                <span className="block text-[#C5A059] text-2xl font-serif-c mb-4 italic">{s.num}</span>
      ...
      <footer id="footer" className="bg-[#121212] text-white py-16 px-6 md:px-12">
        <div className="max-w-screen-2xl mx-auto flex flex-col gap-8 md:flex-row md:justify-between md:items-end">
          <div>
            <h3 className="font-serif-c text-2xl mb-2 italic">Miralegal</h3>
          ...
          <div className="flex flex-col md:items-end gap-2">
            <a href="mailto:contact@miralegal.ru" className="text-lg hover:text-[#C5A059] transition-colors">contact@miralegal.ru</a>
